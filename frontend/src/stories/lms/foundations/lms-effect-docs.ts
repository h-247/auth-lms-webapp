...
export const LMS_EFFECT_DOCS: Record<string, EffectDoc> = {
  ...
  'comic-stat-card': {
    title: 'Comic Stat Card',
    subTitle: 'Thẻ thống kê/số liệu phong cách truyện tranh phản hồi cao',
    aesthetics: 'Kết hợp viền dầy Retro/Comic và bóng đổ phẳng cứng (Hard Shadow Shift). Khi hover, thẻ tự nâng lên và bóng dầy thêm, đồng thời kích hoạt hoa văn bán sắc (Halftone Dot) ẩn dưới nền và hiệu ứng đổi màu đảo ngược (Color-Inversion) kết hợp thu phóng nhẹ (scale-105) cho biểu tượng góc.',
    technical: {
      classes: 'Container: border-2 border-slate-900 dark:border-cyan-400 shadow-[3px_3px_0px_0px_rgba(15,23,42,1)] dark:shadow-[3px_3px_0px_0px_rgba(34,211,238,1)] hover:-translate-x-[1px] hover:-translate-y-[1px] hover:shadow-[4px_4px_...]\nIcon: transform transition-all duration-300 group-hover:scale-105 group-hover:bg-blue-600 group-hover:text-white dark:group-hover:bg-cyan-400 dark:group-hover:text-slate-950\nPattern: opacity-0 group-hover:opacity-15 radial-gradient(circle, currentColor 1.5px, transparent 1.5px) rotate-[10deg]',
      parameters: 'Độ lệch bóng: 3px (khi hover tăng thành 4px)\nHiệu ứng biểu tượng: scale-105 & đảo ngược màu nền/màu chữ\nMật độ bán sắc: 16px',
      code: '<StatCard variant="comic" label="Khóa học đang học" value="4" sub="2 khóa hoàn thành" icon={<BookOpen />} />'
    }
  }
};
